...
const $carousel = $g(".carousel"); // Assuming your carousel container has a class "carousel"

$carousel.addEventListener("mouseover", () => {
    pauseAuto(); // Pause automatic sliding when mouse is over the carousel
});

$carousel.addEventListener("mouseout", () => {
    startAuto(); // Resume automatic sliding when mouse leaves the carousel
});
// startAuto();
